...
You can create rsa public-key and private-key using:
...
You can then execute your native executable with: `./target/simple-firebase-java-quarkus-1.0.0-SNAPSHOT-runner`

If you want to learn more about building native executables, please consult https://quarkus.io/guides/maven-tooling.

## Swagger-UI

You can run the api using swagger-ui at http://localhost:8080/q/swagger-ui.
